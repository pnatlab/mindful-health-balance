...
- [MEAL_COMPOSER_UI.md](MEAL_COMPOSER_UI.md) - Defines the MHB 2.3 Today workspace, calm composition flow, illustrated Meal Type cards, dynamic recorded-meal panel, responsive presentation, and deferred Reflection/workbook boundaries.
