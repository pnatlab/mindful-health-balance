...
- [MEAL_DRAFT_GENTLE_REFLECTION_CONTEXT_BRIDGE.md](MEAL_DRAFT_GENTLE_REFLECTION_CONTEXT_BRIDGE.md) - MHB 2.6I defines the explicit memory-only bridge from a human-confirmed Meal draft to a secondary post-generation Reflection cue, without adding a Root, signal, canonical record, or persistence.
