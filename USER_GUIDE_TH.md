...
คู่มือนี้อธิบายสถานะปัจจุบัน **MHB 2.2 — Daily Log Gap Awareness** ซึ่งต่อยอดจาก MHB 2.1 — Gentle Mind Note และฐาน MHB 2.0 — Field Review, Signal Engine & User Intention Profile โดยไม่เปลี่ยน schema หรือข้อมูลย้อนหลัง
...
MHB 2.1 เปลี่ยนเฉพาะภาษา การจัดกลุ่ม และพื้นที่หายใจของหน้า Mind Note ค่าเดิมยังเปิดและบันทึกได้เหมือนเดิม ส่วน MHB 2.2 เพิ่มเพียงการรับรู้ช่วงเวลาระหว่างวันที่บันทึกจาก `Daily_Log` แบบ runtime โดยไม่มีการเปลี่ยน Excel, Reflection output, Field Review หรือ Signal Engine
