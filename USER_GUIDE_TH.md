...
คู่มือนี้อธิบายสถานะปัจจุบัน **MHB 2.1 — Gentle Mind Note** ซึ่งต่อยอดจากฐาน MHB 2.0 — Field Review, Signal Engine & User Intention Profile โดยไม่เปลี่ยน schema หรือข้อมูลย้อนหลัง
...
MHB 2.1 เปลี่ยนเฉพาะภาษา การจัดกลุ่ม และพื้นที่หายใจของหน้า Mind Note ค่าเดิมยังเปิดและบันทึกได้เหมือนเดิม และไม่มีการเปลี่ยน `Daily_Log`, Excel, Reflection, Field Review หรือ Signal Engine
