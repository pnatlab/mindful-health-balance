...
ตั้งแต่ v1.9.9 — Mindful Practice Context หน้า `ภาวะใจวันนี้ 2/2` เพิ่มการ์ด `ภาวนาก่อนวางใจ` ก่อน Mind Note เพื่อบันทึกฐานภาวนาแบบ optional เช่น ลมหายใจ/กาย คุณภาพใจ ระลึก/วางใจ วาง/เห็นตามจริง ไม่ได้ภาวนา หรืออื่น ๆ พร้อมระยะเวลาโดยประมาณ UI หลักตั้งใจเหลือเฉพาะกลุ่ม daily-use ที่เบา ไม่เปิดกลุ่มเฉพาะทางเกินไป ข้อมูลนี้ถูกเก็บใน Daily Log/Excel เพื่อ Field Review ในอนาคต แต่ Reflection/NuTuenSai รายวันยังไม่ตีความ ไม่ให้คะแนน และไม่ตัดสินการภาวนา
