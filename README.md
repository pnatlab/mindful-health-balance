...
- a small collapsed read-only local Vision vocabulary view in Log that shows observed labels, counts, and mapping status without adding Food References or changing meals
